...
//
const BotName = 'ReVolt-Bot 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/revolt_144'; // Nama Instagramlu cok
const whatsapplu = '0831-6444-5159'; // Nomor whatsapplu cok
const kapanbotaktif = 'Diusahakan 24 Jam,Soalnya Gw Main Solo njink buatnya'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/KBt8lh74kvUJ6gunrVkco4'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/CBnG0Ks2SRtJ1oGv1j1fZG'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ReVolt`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ReVolt`)
})
...
else if (text == 'Syaloom'){
conn.sendMessage(id, 'Syaloom Too, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Syaloom Too, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
